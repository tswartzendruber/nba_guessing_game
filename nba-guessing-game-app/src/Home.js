    ...
    for (i = 0; i < rows.length - 1; i++) {
      ...
      if (n > 2) {
        ...
        const getPositionValue = position => {
          const positionsMap = { "PG": 100, "SG": 200, "SF": 300, "PF": 400, "C": 500 };
          return position.includes('-') ? positionsMap[position.split('-')[0]] + positionsMap[position.split('-')[1]] : positionsMap[position];
        };
